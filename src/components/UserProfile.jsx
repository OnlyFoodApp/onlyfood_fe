      ...
      <div className="flex justify-between items-center">
        ...
        <div className="flex gap-5 items-center mt-6 border-color border-b-1 pb-6">
            <img
              ...
              src="https://scontent.fsgn2-9.fna.fbcdn.net/v/t39.30808-6/371814928_1011031756596599_4734636112190420373_n.jpg?stp=cp6_dst-jpg&_nc_cat=103&ccb=1-7&_nc_sid=5f2048&_nc_ohc=8XWyHhfJiZ8AX9UEu-S&_nc_ht=scontent.fsgn2-9.fna&_nc_e2o=s&oh=00_AfCc50I-OtNWdjY6Eaa0YflPwe-VpVWv9rXTgIF1RQuQSg&oe=653627B9"
            ></img>

            <div>
            <p class="font-semibold text-xl dark:text-gray-200"> Michael Roberts </p>
            <p class="text-gray-500 text-sm dark:text-gray-400">  Administrator   </p>
            <p class="text-gray-500 text-sm font-semibold dark:text-gray-400"> info@shop.com </p>
            </div>
          ...
          <div className="mt-5"> 
        <button className=" text-undefined p-3 w-full hover:drop-shadow-xl hover:bg-undefined" type="button" style={{backgroundColor: `rgb(3, 201, 215)`, color:` white`, borderRadius:` 10px`}}>Logout</button>
          </div>
    </div>
  );
};
